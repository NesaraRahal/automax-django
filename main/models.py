...
from main.const import CARS_BRANDS, TRANSMISSION_OPTIONS
...
class Listing(models.Model):
    ...
    #When you are creating 1 : M relationship with DB U need to put the relationship(on_delete) in the place where 1 which in here 1 listing can have only 1 seller(Profile)
...
class LikedListing(models.Model):
    ...
    like_listing_date = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f'{self.listing.model} like by {self.profile.user.username}'
